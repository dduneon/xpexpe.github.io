...
[Swift - 클래스](https://xpexpe.github.io/posts/swift-d12) 에서 **stored property**와 **computed property** 에 대해서 공부했었는데, 이런 저장 & 연산 프로퍼티 앞에 `static` 키워드를 붙이면 저장 타입 프로퍼티와 연산 타입 프로퍼티가 되는 것
...
> 이는 [Swift - 클래스(Class)](https://xpexpe.github.io/posts/swift-d12/) 에서 참고하면 된다

여기서 앞서 [Swift - 접근 제어](https://xpexpe.github.io/posts/swift-d16/) 에서 언급했었던 `class` 키워드에 대해 알수 있었다
