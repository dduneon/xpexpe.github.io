...
[Swift - 클래스](https;//xpexpe.github.io/swift-s-12) 에서 **stored property**와 **computed property** 에 대해서 공부했었는데, 이런 저장 & 연산 프로퍼티 앞에 `static` 키워드를 붙이면 저장 타입 프로퍼티와 연산 타입 프로퍼티가 되는 것
